...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/maggma-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11311&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/maggma-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `maggma` can be installed with:

```
conda install maggma
```

It is possible to list all of the versions of `maggma` available on your platform with:
